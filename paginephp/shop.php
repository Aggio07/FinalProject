			...
			<div class="griglia-categorie">
				...
				<a href="pasticceria.php" class="scheda-categoria">
					...
					<div class="contenuto-categoria">
						<p class="categoria-piccola">Categoria</p>
						<h2>La nostra pasticceria</h2>
						<p>
							Dolci artigianali, panettoni, biscotti e creazioni della casa
							preparate con ingredienti selezionati.
						</p>
				...
				<a href="vini.php" class="scheda-categoria">
					...
					<div class="contenuto-categoria">
						...
						<h2>I nostri vini</h2>
						<p>
							Una selezione di bottiglie scelte per accompagnare
							l’esperienza gastronomica del nostro ristorante.
						</p>
						<span class="link-categoria">Scopri di più</span>
					</div>
				</a>
				...
				<a href="gourmet.php" class="scheda-categoria">
					...
					<div class="contenuto-categoria">
						...
						<p>
							Olio, pasta artigianale, sughi e specialità selezionate
							per portare La Maison anche a casa.
						</p>
						<span class="link-categoria">Scopri di più</span>
					</div>
				</a>
